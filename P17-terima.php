...
<table border="1" class="table">
        <tr><td>Id_Menu</td>
    <td><input type="text" name="id_menu" size="11" maxlength="10" 
    value="<?php echo $datamenu["id_menu"]?>" readonly></td></tr>
    <tr><td>nama_menu</td>
    <td><input type="text" name="nama_menu" size="30" maxlength="31" 
    value="<?php echo $datamenu["nama_menu"]?>" readonly></td></tr>
    <tr><td>harga</td>
    <td><input type="text" name="harga" size="10" maxlength="11" 
    value="<?php echo $datamenu["harga"]?>" readonly></td></tr>
    <input class="btn17-2" type="submit" name="terimamenu" value="Terima">
</table>
    <?php
    }
    else
